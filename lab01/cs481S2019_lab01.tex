...
description of GatorGrader, you will see that it was developed by students who
previously took this course.
%
...
academic and industrial institutions. You should review GatorGrader's issue
...
of GatorGrader, the tasks for this project are not limited to those that are
...
\section*{Self Evaluation and Retrospective}
...
\item Submitted through your repository created by GitHub Classroom, a self
  ...
  the contributions that you made to the GatorGrader project. This document
  should also detail the ways in which you helped teachers and students learn
  how to use the GatorGrader tool.
